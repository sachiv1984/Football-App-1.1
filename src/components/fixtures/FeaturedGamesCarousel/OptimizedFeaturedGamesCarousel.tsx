...
const OptimizedFeaturedGamesCarousel: React.FC<Props> = ({
  ...
  const getLogo = (team: any) =>
    team?.crest ||
    (team?.shortName
      ? `/team-logos/${team.shortName.replace(/\s+/g, "-").toLowerCase()}.png`
      : "/team-logos/default.png");

  if (totalFixtures === 0) return null;
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <div className="text-xs sm:text-sm text-gray-500">
                  {currentFixture.competition?.name}
                </div>
              </div>
              ...
              <div className="flex justify-around items-center">
                ...
                <div className="flex flex-col items-center w-1/3">
                  ...
                  <div className="mt-2 text-sm font-medium text-purple-600">
                    {formatDate(currentFixture.dateTime)}
                  </div>
              ...
              {/* Tags */}
              {currentFixture.tags && currentFixture.tags.length > 0 && (

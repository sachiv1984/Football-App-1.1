...
const OptimizedFeaturedGamesCarousel: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className="relative flex flex-col flex-shrink-0 h-full rounded-xl"
      style={{
    ...
    >
      <button
        className={`carousel-card flex flex-col justify-between h-full w-full p-4 bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-focus-gold ${

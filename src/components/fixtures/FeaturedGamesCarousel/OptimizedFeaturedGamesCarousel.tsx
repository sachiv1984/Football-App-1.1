        ...
        {showNavigation && (
          <>
            <button
              ...
              style={{ width: '48px', height: '48px', transform: 'translateX(-100%) translateY(-50%)', left: '40px' }}
            ...
            <button
              ...
              style={{ width: '48px', height: '48px', transform: 'translateX(100%) translateY(-50%)', right: '40px' }}

          ...
          {fixtures.map((fixture) => {
            ...
            return (
              <SwiperSlide key={fixture.id}>
                <button
                  className="carousel-card flex flex-col justify-between w-full p-[var(--space-md)] bg-[var(--color-background)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-focus-gold)] rounded-xl shadow-card transition-all duration-300 min-h-[300px]"
                  onClick={() => onGameSelect?.(fixture)}
                  aria-label={`View match between ${fixture.homeTeam.name} and ${fixture.awayTeam.name}`}
                >
                  {/* Competition & Week */}
                  <div className="flex justify-between items-center mb-[var(--space-sm)] w-full px-[var(--space-sm)]">
                  ...
                  <div className="flex justify-center items-center mb-[var(--space-sm)] w-full flex-1">
                    <div className="flex items-center justify-between w-full max-w-[300px]">
                      {/* Home Team */}
                      <div className="flex flex-col items-center min-w-0 w-[80px]">

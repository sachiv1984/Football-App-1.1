...
const OptimizedFeaturedGamesCarousel: React.FC<Props> = ({ fixtures }) => {
  ...
  return (
    <div
      className="w-full bg-gradient-to-r from-purple-700 via-purple-600 to-purple-700 rounded-xl shadow-lg overflow-hidden relative"
            ...
            >
              <div className="bg-white rounded-xl shadow-xl p-6 w-[95%] sm:w-[85%] max-w-2xl mx-auto">
                {(() => {
                  ...
                  // ✅ Use matchWeek from API instead of calculating calendar week
                  const weekNumber = fixture.matchWeek ?? 1;

...
interface RecentMatch {
  ...
  hit: boolean;
  date?: string;
  isHome?: boolean; // Essential for correct venue display
}
...
export interface BettingInsight {
  ...
  // NEW MATCH CONTEXT FIELD (for enriched insights)
  matchContext?: MatchContext; 
}

interface MatchBettingPatternsProps {
  // We expect an array of the enriched insights (MatchContextInsight) here

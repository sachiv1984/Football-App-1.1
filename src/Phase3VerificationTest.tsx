...
const FixtureCard = ({ fixture, size = 'md', onClick }: any) => {
...
const FixturesList = ({ fixtures, title, cardSize = 'md', onFixtureClick }: any) => (
  <div>
    {title && (
      <div className="mb-6">
...
const LeagueTable = ({ teams = [], title }: any) => {
...
const Phase3VerificationTest = () => {
  ...
  const TestSection = ({ title, children, testKey }: { title: string; children: React.ReactNode; testKey: string }) => (
    <Card className="mb-6">
      <Card.Header 
        title={title}
        action={
      ...
      <div className="space-y-4">
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
          <FixturesList 
            ...
            onFixtureClick={(fixture: any) => runTest(`fixturesList${fixture.id}`, true)}
          />
        </div>
